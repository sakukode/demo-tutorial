...
class Pagination_bootstrap_style extends CI_Controller
{
    ...
    public function index($page = 1)
    {
        ...
        $url = site_url('pagination_bootstrap_style/index');
        ...
        //load view
        $this->load->view('pages/pagination-bootstrap', $data);
    }

}

/* application/controllers/Pagination_bootstrap_style.php */
